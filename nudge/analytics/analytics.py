...
def get_longest_streak(habit: Habit) -> int:
    ...
    match habit.periodicity:
        case habit.periodicity.DAILY:
            longest_streak = _get_longest_streak_daily(timestamps)
        case habit.periodicity.WEEKLY:
            longest_streak = _get_longest_streak_weekly(timestamps)
        case habit.periodicity.WEEKLY_FIXED_DAY:
            longest_streak = _get_longest_streak_weekly_fixed_day(timestamps)
        case habit.periodicity.MONTHLY:
            longest_streak = _get_longest_streak_monthly(timestamps)
        case habit.periodicity.MONTHLY_FIXED_DAY:
            longest_streak = _get_longest_streak_monthly_fixed_day(timestamps)

    return longest_streak


def _get_longest_streak_daily(timestamps: List[datetime]) -> int:
    longest_streak = 1
    current_streak = 1
...
def _get_longest_streak_weekly(timestamps: List[datetime]) -> int:
    longest_streak = 1
    current_streak = 1
...
def _get_longest_streak_monthly(timestamps: List[datetime]) -> int:
    longest_streak = 1
    current_streak = 1
...
def _get_longest_streak_weekly_fixed_day(timestamps: List[datetime]) -> int:
    longest_streak = 1
    current_streak = 1
...
def _get_longest_streak_monthly_fixed_day(timestamps: List[datetime]) -> int:
    longest_streak = 1
    current_streak = 1
